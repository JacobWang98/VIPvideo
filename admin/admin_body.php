    ...
    <body>
        <div class="x-body layui-anim layui-anim-up">
            <blockquote class="layui-elem-quote">
                ...
                &nbsp;&nbsp;最新版本：<script language="JavaScript" type="text/javascript" charset="utf-8" src="//api.nohacks.cn/save/ver.js?ver=<?php echo uniqid()?>"></script>
                &nbsp;&nbsp;当前云规则版本：<script language="JavaScript" type="text/javascript" charset="utf-8" src="../save/yun.ver.js?ver=<?php echo uniqid()?>"></script>
                &nbsp;&nbsp;最新版本：<script language="JavaScript" type="text/javascript" charset="utf-8" src="//api.nohacks.cn/save/yun.ver.js?ver=<?php echo uniqid()?>"></script>
                    ...
                    <table class="layui-table">
                        <tbody>
                            <tr>
                                <th>版权所有</th>
                                <td>
                                    <a href="http://nohacks.cn/" class='x-a' target="_blank">nohacks.cn</a></td>
                            </tr>
                            <tr>
                                <th>开发者</th>
                                <td>nohacks(23453161@qq.com)</td></tr>
                        </tbody>
                    </table>
                </div>
            </fieldset>
            <blockquote class="layui-elem-quote layui-quote-nm">欢迎访问官方主页获取帮助：<a href="//nohacks.cn" target="_blank">nohacks.cn</a>,官方QQ群：8124645</blockquote>
        </div>
