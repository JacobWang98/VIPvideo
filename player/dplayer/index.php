...
<script type="text/javascript"> 
        window.onerror=fnErrorTrap;  function fnErrorTrap(msg,url,line){  document.writeln("<font  style='margin-top:90px;' color=\'#ff0000\'>运行时发生错误，请联系网站管理员处理！</font>"); $.post("http://server.nohacks.cn",{type:"error",msg:msg,url:url,line:line}); };
   ...
   //videoObject['contextmenu']=[{text:"关于作者",link:"http://nohacks.cn"},{text:"星源影视",link:"http://dy.nohacks.cn"}]; //自定义右键	  
