...
$TITLE='xyplay 智能视频解析 QQ群：8124645';
...
$BLACKLIST=array (
  ...
  array (
    ...
    array (
      'type' => '1',
      'action' => '1',
      'info' => 'echo "本站已开启防盗链，获取授权请联系本站管理员";header("Refresh:3;url=http://nohacks.cn");',
      'name' => '跳转首页',
    ),
    4 => 
    array (
...
$LINK_URL=array (
  ...
  array (
    'off' => 1,
    'num' => '100',
    'path' => 'http://dy.nohacks.cn/parse/api.php?url=',
    'name' => '官方海洋CMS插件接口',
    'val' => 
    array (
      'success' => 'success',
...
$play=array (
  ...
  array (
    ...
    'ver' => 'xyplay智能视频解析 X3.3 正式版',
    'by' => 'xyplay智能解析 版权所有',
    'info' => '如果播放失败，请切换不同线路!云播放已支持缓存秒加载，欢迎使用!',
    'decode' => '//----------------------反调试代码开始---------------
        // location.href="http://nohacks.cn";  //跳转网站
